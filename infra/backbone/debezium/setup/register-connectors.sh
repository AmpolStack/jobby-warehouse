...
register_connector "user-database-connector-v2"    "/connectors/user-database-config.json"
register_connector "product-database-connector-v2" "/connectors/product-database-config.json"
register_connector "sales-database-connector-v2"   "/connectors/sales-database.json"
